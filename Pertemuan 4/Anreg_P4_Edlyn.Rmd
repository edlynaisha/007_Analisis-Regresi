...
x1 <- runif(n,5,15) #menyebar seragam dari 5-15 
x2 <- rnorm(n,3,3) #menyebar normal dari rataan 3, ragam 3
x0 <- rep(1,n) #dibuat seperti data frame nilai 1 hingga n
...
```{r}
par(mfrow=c(1,2)) #parameter (bagi jendela plot 1 baris 2 kol)
plot(x1, y, pch=19) #pch 19 itu bikin titik bulat amatan
plot(x2, y, pch=19)
```
...
Didapatkan persamaan regresi yaitu $y = 5.107617 + 2.993197x_1 + 2.104676x_2$
...
summary(model_reg)
```
Didapatkan persamaan regresi yaitu $y = 5.1076  + 2.9932x_1 + 2.1047x_2$
